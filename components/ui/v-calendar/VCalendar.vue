...
const calendarRef = computed<InstanceType<typeof Calendar> | null>(
...
.calendar .vc-pane-layout {
  @apply grid gap-4 mobile:!grid-cols-1;
}
.calendar .vc-title {
...
.calendar .vc-day.is-today:not(:has(.vc-day-layer)) .vc-day-content {
  @apply bg-gray-200 text-accent-foreground rounded-md;
}
...
.calendar.mode-time .vc-time-header span {
  display: none;
}
/**
 * Timepicker styles
