...
<template>
  <ContentsSignUpCheckSession
    :check-path="`(${useEtcRoute('/sign-up/profile')}|${useEtcRoute('/sign-up')}|${useEtcRoute('/sign-up/kakao-enter-id')}|${useEtcRoute('/sign-up/kakao-verify-phone')}|${useEtcRoute('/login')}|/m/join/kakao/permalink?.+|/etc/kakao-permalink?.+)`"
